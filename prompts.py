...
КРИТИЧЕСКИ ВАЖНО:
- ВСЕ тексты для пользователя (overall_assessment, issue, why, fix_suggestion, note, risks, candidate_questions, priority_fix_list, а также все поля в дополнительных оценках) должны быть СТРОГО на русском языке. ЗАПРЕЩЕНО использовать английские слова типа "optimal", "meets", "MEDIUM", "high", "low", "rating" и т.п. в текстах для пользователя.
...
- Дополнительные оценки (все тексты СТРОГО на русском языке, без английских слов):
  ...
  * Оценка релевантности: объект {{"рейтинг":"высокий|средний|низкий","обоснование":"текст объяснения"}}.
  Используй русские слова для рейтинга: "высокий", "средний", "низкий" (НЕ "high", "medium", "low", "MEDIUM" и т.п.).
